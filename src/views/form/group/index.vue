            ...
            <a-space direction="vertical" :size="16">
                <a-card class="general-card">
                    ...
                    <a-row :gutter="80">
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.video.acquisition.resolution')"
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.video.acquisition.frameRate')"
                    ...
                    <a-row :gutter="80">
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.video.encoding.resolution')"
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.video.encoding.rate.min')"
                                field="video.encoding.rate.min">
                                <a-input :placeholder="$t('groupForm.placeholder.video.encoding.rate.min')
                                    " add-after="bps">
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.video.encoding.rate.max')"
                    ...
                    <a-row :gutter="80">
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.video.encoding.rate.default')"
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.video.encoding.frameRate')"
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.video.encoding.profile')"
                ...
                <a-card class="general-card">
                    ...
                    <a-row :gutter="80">
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.audio.acquisition.channels')"
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.audio.encoding.channels')"
                    ...
                    <a-row :gutter="80">
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.audio.encoding.rate')"
                        ...
                        <a-col :span="8">
                            <a-form-item :label="$t('groupForm.form.label.audio.encoding.profile')"
