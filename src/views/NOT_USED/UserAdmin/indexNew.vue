      ...
      <a-space direction="vertical" :size="16">
        <a-card class="general-card" :bordered="false">
            ...
            <a-col :span="12">
              <a-form-item
                ...
                :rules="[
                  {
                    required: true,
                    message: $t('user.form.validation.usernameRequired'),
                  },
                ]"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                ...
                :rules="[
                  {
                    required: true,
                    message: $t('user.form.validation.passwordRequired'),
                  },
                ]"
              >
                <a-input-password
              ...
              <a-form-item
                v-else-if="isEdit"
                :label="$t('user.form.label.newPassword')"
                field="password"
              >
                <a-input-password
                  v-model="formData.password"
          ...
          <a-row :gutter="16">
            <a-col :span="12">
              <a-form-item
                ...
                :rules="[
                  {
                    required: true,
                    message: $t('user.form.validation.emailRequired'),
                  },
                  {
                    type: 'email',
                    message: $t('user.form.validation.emailInvalid'),
                  },
                ]"
              >
                <a-input
            ...
            <a-col :span="12">
              <a-form-item
                :label="$t('user.form.label.telephone')"
                field="telephone"
              >
                <a-input
          ...
          <a-form-item
            :label="$t('user.form.label.userPermissions')"
            field="userPermissions"
            :rules="[
              {
                required: true,
                message: $t('user.form.validation.userPermissionsRequired'),
              },
            ]"
          >
            <a-select
              v-model="formData.userPermissions"
              :placeholder="$t('user.form.placeholder.userPermissions')"
              :disabled="!isEdit && !isCreate"
            >
              <a-option value="admin">{{
                $t('user.form.option.admin')
              }}</a-option>
              <a-option value="user">{{
                $t('user.form.option.user')
              }}</a-option>
              <a-option value="guest">{{
                $t('user.form.option.guest')
              }}</a-option>
            </a-select>
          </a-form-item>
        </a-card>
